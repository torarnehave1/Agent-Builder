...
export default function NotifyNode({ data }: { data: NotifyData }) {
  return (
    <div className="rounded-lg border border-rose-500/30 bg-rose-500/10 px-3 py-2 min-w-[140px] backdrop-blur-sm">
      ...
      <div className="text-[12px] text-rose-200">🔔 {data.channel}</div>
