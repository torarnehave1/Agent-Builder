...
const need = ['unsupportedSelectorReason', 'parseSelector', 'matchesSelector', 'findElementRange', 'countHtmlTags', 'tabsPreservationCheck', 'topLevelChildRanges', 'autoTabsContainer', 'resolveTabTargets']
for (const n of need) {
