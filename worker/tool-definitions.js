  ...
  },
  {
    ...
    input_schema: {
      ...
      properties: {
        ...
        founder_email: { type: 'string', description: 'Required for token-gated servers (cloudflare-observability, cloudflare-bindings): whose Cloudflare account to query, e.g. stine.oksvold@gmail.com. Uses THAT founder\'s own stored cf_api_token. Omit to use the platform admin\'s own account. Ignored by cloudflare-docs, which is public.' }
      },
      required: ['server']
    }
  },
