  ...
  },
  {
    ...
    input_schema: {
      ...
      properties: {
        ...
        force: { type: 'boolean', description: 'Redeploy the script even if the worker already exists. NOTE: this replaces the ENTIRE binding set with HTML_PAGES + BRAND_CONFIG + HTML_PUBLISH_SECRET + DEFAULT_ORIGIN — pass default_origin to preserve passthrough.' },
      },
      required: ['domain'],
    },
  },
